...
# Data ingestion
#========
df_data = pd.read_csv(r"C:\Users\Notebook\Desktop\Dashboards Interativos com Python - Asimov Academy\3. Dashboards Interativos com Python\3. Desenvolvimento de projetos\1. Análise de vendas de imóveis\cleaned_data.csv",index_col=0)
...
def update_hist(location, square_size, color_map):
    ...
    px.set_mapbox_access_token("pk.eyJ1IjoibHV6b2FraSIsImEiOiJjbDltbnliNzkwMjQyM25xbTZveHQxamtqIn0.a5YKCqrBaY4DsL1p-uB1EQ")
...
if __name__ == "__main__":
    ...
    #app.run_server(host="0.0.0.0", port="8050") # quando for colocar em produção